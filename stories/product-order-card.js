...
const products = [
	...
	// Default
	{
		...
		img: 'https://pressed-product-images.s3-us-west-1.amazonaws.com/test/bragg-greens.png',
		nonMemberPrice: 6.75,
...
export function NonMemberDiscountSamePrice() {
	return {
		...
		data() {
			return {
				sampleProduct: products[3], // eslint-disable-line
				quantity: 0,
			};
		},
	};
...
export function NonMemberDiscountAndMemberDiscount() {
	return {
		...
		data() {
			return {
				sampleProduct: products[4], // eslint-disable-line
				quantity: 0,
			};
		},
	};
...
export function NonMemberDiscountAndMemberDiscountSamePrice() {
	return {
		...
		data() {
			return {
				sampleProduct: products[5], // eslint-disable-line
				quantity: 0,
			};
		},
	};
...
export function MemberDiscount() {
	return {
		...
		data() {
			return {
				sampleProduct: products[6], // eslint-disable-line
				quantity: 0,
			};
		},
	};
